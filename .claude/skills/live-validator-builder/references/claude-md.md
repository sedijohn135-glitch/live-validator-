# Content for CLAUDE.md (write exactly this, between the lines, to the repo root)

Keep CLAUDE.md short: it is loaded in every session and costs tokens every time.
