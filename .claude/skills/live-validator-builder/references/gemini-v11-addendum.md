# Content for `docs/GEMINI_V11_ADDENDUM.md` — the owner pastes it at the END of the v11 skill in Gemini Spark

Keep tool and parameter names identical to the implementation (a test enforces it).
